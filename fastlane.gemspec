...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency('bundler', '>= 1.12.0', '< 2.5.0') # Used for fastlane plugins
  ...
  spec.add_dependency('domain_name', '>= 0.5', '< 0.6') # Must be < 0.6 to support Ruby 2.6
  spec.add_dependency('google-cloud-storage', '>= 1.31', '< 1.44') # Must be < 1.44 to support Ruby 2.6
